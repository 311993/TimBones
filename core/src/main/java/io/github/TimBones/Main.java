...
public class Main extends ApplicationAdapter {
    ...
    public void create() {
        ...
        //int[] attrTable = {0x00000000, 0x55555555, 0xAAAAAAAA, 0xFFFFFFFF, 0x00000000, 0x55555555, 0xAAAAAAAA, 0xFFFFFFFF, 0x00000000, 0x55555555, 0xAAAAAAAA, 0xFFFFFFFF, 0x00000000, 0x55555555, 0xAAAAAAAA, 0xFFFFFFFF,};
        ppu.setAttributeTable(attrTable);
    }

    @Override
    public void render() {
        ppu.sendToOAM(0x10000000);
        ...
        ppu.render(viewport, new byte[1023], t % 16 + 16, t % 16 + 16);
        t--;
    }
